...
const Header = () => {
    ...
    return (
        ...
        viewport={{once:true}}
        >
            <motion.div className='text-stone-500 inline-flex text-center gap-2 bg-white py-1 px-6 border-neutral-500 rounded-full border'
            ...
            className='flex flex-wrap justify-center gap-3  mx-auto mt-16'>
